import 'package:bnu_lms/features/notification/presentation/widgets/tab_item.dart';
  ...
  List<Map<String, dynamic>> _getNotifications({
    ...
    final allNotifications = [
      ...
      },
      {
        ...
        'indicatorColor': ColorsManager.blue.withOpacity(0.7),
        'isRead': true,
        'isAnnouncement': true,
      },
      {
        ...
        'indicatorColor': Colors.orange.withOpacity(0.7),
        'isRead': true,
        'isAnnouncement': false,
      },
    ];
